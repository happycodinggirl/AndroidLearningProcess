 ...
 */
public class WebSocketActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServerInfo[] serverInfos = {new ServerInfo("连接Java Web后台", "ws://192.168.1" + "" +
                ".104:80/JSR356-WebSocket/websocket/"), new ServerInfo("连接Java Application后台", "ws://192.168.1" + "" +
                ".104:8887")};// 所有连接后台
